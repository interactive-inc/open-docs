...
import type { DocFileSystemReadType } from "./types"
 ...
 */
export class DocFileSystemJsonRead implements DocFileSystemReadType {
   ...
   */
  async getFileModifiedTime(_relativePath: string): Promise<Date | Error> {
